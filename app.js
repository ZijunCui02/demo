...
(function () {
    ...
    var SAVE_ENDPOINTS = ["api/verdicts", "https://eve.tail5cf4e4.ts.net/api/verdicts", "http://localhost:8321/save"];
    ...
    function hydrateFromServer(done) {
        var GETS = ["api/verdicts", "https://eve.tail5cf4e4.ts.net/api/verdicts"];
        function tryGet(i) {
